(module
 ...
 (export "convertToGrayscale" (func $export:assembly/index/convertToGrayscale))
 (start $~start)
 ...
 (func $assembly/index/convertToGrayscale (param $imageData i32) (result i32)
  (local $len i32)
  (local $i i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
 ...
 (func $export:assembly/index/convertToGrayscale (param $0 i32) (result i32)
  (local $1 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
  ...
  i32.store
  local.get $0
  call $assembly/index/convertToGrayscale
  local.set $1
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.add
